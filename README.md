...
------------ | -------------
/intel/pcm/ACYC|  number of active cycles                
/intel/pcm/AFREQ| relation to nominal CPU frequency while in active state
/intel/pcm/C0res%| residency of core 0
/intel/pcm/C1res%| residency of core 1
/intel/pcm/C2res%| residency of core 2
/intel/pcm/C3res%| residency of core 3
/intel/pcm/Cres%| residency of cores
/intel/pcm/EXEC| exec instructions per nominal CPU cycle             
/intel/pcm/FREQ| relation to nominal CPU frequency            
/intel/pcm/INST| number of instructions retired            
/intel/pcm/INSTnom| instructions per nominal CPU cycle              
/intel/pcm/INSTnom%| instructions per nominal CPU cycle in percentage         
/intel/pcm/IPC| inter-process communication instructions per CPU cycle          
/intel/pcm/L2HIT| L2 cache hit ratio (0.00-1.00)            
/intel/pcm/L2MISS| L2 cache misses (including other core's L2 cache *hits*)             
/intel/pcm/L2MPI| number of L2 cache misses per instruction            
/intel/pcm/L3HIT| L3 cache hit ratio (0.00-1.00)          
/intel/pcm/L3MISS| L3 cache misses            
/intel/pcm/L3MPI|  number of L3 cache misses per instruction            
/intel/pcm/PhysIPC| physical core IPC          
/intel/pcm/PhysIPC%| physical core IPC in percentage              
/intel/pcm/ProcEnergy(Joules)| CPU energy in Joules
/intel/pcm/READ| bytes read from memory controller (in GBytes)
/intel/pcm/SKT0| CPU energy in Joules per socket 0
/intel/pcm/TEMP| Temperature reading in 1 degree Celsius relative to the TjMax temperature (thermal headroom)
/intel/pcm/TIME(ticks)| Time in ticks
